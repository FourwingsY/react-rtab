...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRtab = __webpack_require__(159);

	var _reactRtab2 = _interopRequireDefault(_reactRtab);

	var _withRenderer = __webpack_require__(162);

	var _withRenderer2 = _interopRequireDefault(_withRenderer);

	var _withInstance = __webpack_require__(163);

	var _withInstance2 = _interopRequireDefault(_withInstance);

	var _withFunction = __webpack_require__(164);

	var _withFunction2 = _interopRequireDefault(_withFunction);

	var _complexTabs = __webpack_require__(165);

	var _complexTabs2 = _interopRequireDefault(_complexTabs);
	  ...
	  function App() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(App)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      models: [{
	        ...
	        panel: _react2.default.createElement(_withRenderer2.default, null)
	      }, {
	        tab: "Instance",
	        panel: _react2.default.createElement(_withInstance2.default, null)
	      }, {
	        tab: "Function Model",
	        panel: _react2.default.createElement(_withFunction2.default, null)
	      }, {
	        tab: "Binding",
	        panel: _react2.default.createElement(_complexTabs2.default, null)
	      }]
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_reactRtab2.default, {
	          models: this.state.models,
	          panelRenderer: function panelRenderer(panelModel) {
	            return panelModel;
	          },
	          draggable: true, closable: true,
	          onChange: function onChange(models) {
	            return _this2.setState({ models: models });
	          }
	        })
	      );
	    }
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('examples'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rtab = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var code = 'class RendererTab extends React.Component {\n  render() {\n    let models = [{\n      tab: "Tab 1",\n      panel: [{\n        title: "Hello",\n        body: "Hello world! This is React-Tabs"\n      },{\n        title: "And this...",\n        body: "is the very useful!"\n      }]\n    }, {\n      tab: "Tab 2",\n      panel: [{\n        title: "This is second Tab",\n        body: "Tabs are using same renderer"\n      }]\n    }]\n\n    let panelRenderer = (panelModel) => {\n      return panelModel.map((data) => {\n        return ([\n          <h2 key="title">{data.title}</h2>,\n          <p key="body">{data.body}</p>\n        ])\n      })\n    }\n    let tabRenderer = (tabModel) => {\n      return <a>{tabModel}</a>\n    }\n    return (\n      <Rtab\n        models={models}\n        panelRenderer={panelRenderer}\n        tabRenderer={tabRenderer}\n        tabPosition="left"\n      />\n    )\n  }\n}';

	var RendererTab = function (_React$Component) {
	  _inherits(RendererTab, _React$Component);

	  function RendererTab() {
	    _classCallCheck(this, RendererTab);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(RendererTab).apply(this, arguments));
	  }

	  _createClass(RendererTab, [{
	    key: 'render',
	    value: function render() {
	      var models = [{
	        tab: "Tab 1",
	      ...
	      var panelRenderer = function panelRenderer(panelModel) {
	        return panelModel.map(function (data) {
	          return [_react2.default.createElement(
	            'h2',
	            { key: 'title' },
	            data.title
	      ...
	      var tabRenderer = function tabRenderer(tabModel) {
	        return _react2.default.createElement(
	          'a',
	          null,
	          tabModel
...
/***/ function(module, exports, __webpack_require__) {
	...
	var code = 'class InstanceTab extends React.Component {\n  render() {\n    let models = [{\n      tab: "Page 1",\n      panel: <Page1 />\n    }, {\n      tab: "Page 2",\n      panel: <Page2 />\n    }]\n    return (\n      <Rtab\n        models={models}\n        preserve\n      />\n    )\n  }\n}';

	var InstanceTab = function (_React$Component) {
	  _inherits(InstanceTab, _React$Component);

	  function InstanceTab() {
	    _classCallCheck(this, InstanceTab);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InstanceTab).apply(this, arguments));
	  }

	  _createClass(InstanceTab, [{
	    key: 'render',
	    value: function render() {
	      var models = [{
	        tab: "Page 1",
	        panel: _react2.default.createElement(Page1, null)
	      }, {
	        tab: "Page 2",
	        panel: _react2.default.createElement(Page2, null)
	      }];
	      return _react2.default.createElement(
	        'div',
	        null,
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'this is an example page for Component Instance rendering'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          'When tab change, component is unmounted. If you have tags like <input> in your document, you might want to prevent unmount. Then use \'preserve\' option.'
	        ),
	        _react2.default.createElement('input', { defaultValue: 'Test1' })
	      );
	    }
	  }]);
	  ...
	  _createClass(Page2, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { defaultValue: 'Test2' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FunctionTabs = function (_React$Component) {
	  ...
	  function FunctionTabs() {
	    ...
	    _classCallCheck(this, FunctionTabs);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(FunctionTabs)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      data: [{ age: 23, name: "Mark" }, { age: 25, name: "Bill" }, { age: 44, name: "John" }, { age: 56, name: "Steve" }],
	      models: [{
	        tab: "Young",
	        panel: function panel() {
	          return _this.state.data.filter(function (person) {
	    ...
	    }, _this.panelRenderer = function (panelModel) {
	      return panelModel.map(function (person, idx) {
	        return _react2.default.createElement(
	          'button',
	          { key: idx },
	          person.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComplexTabs = function (_React$Component) {
	  ...
	  function ComplexTabs() {
	    ...
	    _classCallCheck(this, ComplexTabs);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ComplexTabs)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      commonData: ["Example", "Binding"],
	      models: [{
	        tab: "Page 1",
	        panel: "Add Props on Tab 1"
	    ...
	    }, _this.onModelChange = function (idx) {
	      return function (event) {
	        var newData = _this.state.commonData;
	        newData[idx] = event.target.value;
	        _this.setState({
	          commonData: newData
	        });
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRtab2.default, {
	          models: this.state.models,
	          tabRenderer: function tabRenderer(tabModel, idx) {
	            return _react2.default.createElement(ComplexTab, { tab: tabModel, common: _this2.state.commonData[idx] });
	          },
	          panelRenderer: function panelRenderer(panelModel, idx) {
	            return _react2.default.createElement(ComplexPanel, { panel: panelModel, common: _this2.state.commonData[idx], onChange: _this2.onModelChange(idx) });
	          },
	          preserve: true
	        }),
	        _react2.default.createElement(
	...
	exports.default = ComplexTabs;

	var ComplexTab = function (_React$Component2) {
	  _inherits(ComplexTab, _React$Component2);

	  function ComplexTab() {
	    _classCallCheck(this, ComplexTab);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ComplexTab).apply(this, arguments));
	  }

	  _createClass(ComplexTab, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'p',
	...
	var ComplexPanel = function (_React$Component3) {
	  _inherits(ComplexPanel, _React$Component3);

	  function ComplexPanel() {
	    _classCallCheck(this, ComplexPanel);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ComplexPanel).apply(this, arguments));
	  }

	  _createClass(ComplexPanel, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement('input', { value: this.props.common, onChange: this.props.onChange })
	      );
	    }
	  }]);
